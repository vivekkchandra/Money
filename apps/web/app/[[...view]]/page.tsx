...
export async function generateMetadata({ params }: { params: Promise<{ view?: string[] }> }): Promise<Metadata> {
  ...
  return { robots: { index: publicPage && process.env.MONEY_ENV === "production", follow: publicPage && process.env.MONEY_ENV === "production" } };
}
...
export default async function Page({ params }: { params: Promise<{ view?: string[] }> }) {
  ...
  return <Workspace view={view} commercial={saas} />;
}
