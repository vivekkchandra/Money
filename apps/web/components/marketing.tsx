...
const pages: Record<string, {
  ...
  "how-it-works": {
    ...
    sections: [[
      ...
      "TradingAgents, ai-hedge-fund and Qlib receive the same objective evidence, without access to one another's first-pass conclusions."
    ], [
      "03 · Lock, validate and challenge",
      "The original reports are sealed. LEAN tests historical behaviour. CrewAI audits evidence, examines contradictions and applies adversarial review."
    ], [
