...
import { LocalResearchArtifactViewer } from "./research-testing";

export function PersonalRndNotice({ className = "" }: { className?: string }) {
  return <aside className={`notice rnd-notice ${className}`} aria-label="Personal research and development mode"><strong>R&D / PERSONAL USE</strong><span>Real public-source data, possibly delayed. Not commercially licensed or qualified investment research. Live broker membership and research qualification may be unverified. No trade execution, recommendations or production signals.</span></aside>;
}
