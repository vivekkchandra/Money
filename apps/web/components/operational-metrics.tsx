  ...
  return <section className="panel">
    ...
    {metrics ? <>
      ...
      <div className="health-grid">
        ...
        <section className="health-card"><h3>Cost estimates</h3><DataRecord data={{ estimated_cost_subtotal: metrics.costs.known_count === 0 ? "Unknown" : knownCost(metrics.costs.known_total), estimated_cost_invocations: metrics.costs.known_count, unknown_cost_invocations: metrics.costs.unknown_count }} /><p className="small-print">Recorded amounts are estimates or unverified reports. Actual invoiced costs remain unknown. This subtotal excludes unknown costs and is not a provider invoice or complete spend figure.</p></section>
